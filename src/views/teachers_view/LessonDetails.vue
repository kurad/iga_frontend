        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4 mt-4" id="objective_div">
                ...
                <div class="card-footer small text-muted">
                    <a href="#" class="btn btn-success btn-sm float-start" @click.prevent="edit_objective"><i
                            class="fas fa-pencil"></i> <b>Edit
                            Objectives</b></a>
                </div>
            ...
            <div class="card mb-4" id="lesson-content-div">
                ...
                <div class="card-footer small text-muted" v-if="topics.topic_content">Last Updated:
                    ...
                    <a href="#" class="btn btn-success btn-sm float-end" @click.prevent="edit_content"><i
                            class="fas fa-pencil"></i> <b>Edit Content</b></a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6" id="video-div">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" v-if="topics.video_link">
                            <iframe width="450" height="350" :src="topics.video_link"></iframe>
                        </div>
                        <div class="card-body" v-else>
                        ...
                        <div class="card-footer small text-muted" v-if="topics.video_link">
                            <a href="#" class="btn btn-success btn-sm" @click.prevent="edit_video_link"><i
                                    class="fas fa-pencil"></i><b> Edit Video Link</b></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6" id="exercise-div">
                    <div class="card mb-4">
                        ...
                        <div class="card-footer small text-muted" v-if="all_exercises.exercises">
                            <a href="#" class="btn btn-success btn-sm" @click.prevent="edit_exercise"><i
                                    class="fas fa-pencil"></i><b> Edit Exercise(s)</b></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <form @submit.prevent="updateObjective()">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="md-form mt-3">
                                <input type="text" v-model="topics.id" class="form-control">
                                <label class="mb-3">Instructional Objectives</label>
                                <QuillEditor theme="snow" v-model:content="topics.instructional_objectives"
                                    content-type="html" />
                            </div>
                        </div>
                        <div class="modal-footer">
                ...
                <form @submit.prevent="updateTopicContent()">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="md-form mt-3">
                                <label class="mb-3">Write Content / Copy and Paste</label>
                                <QuillEditor theme="snow" v-model:content="topics.topic_content" content-type="html" />
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="md-form mt-3">
                                ...
                                <input type="text" class="form-control" v-model="videoForm.video_link">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                ...
                <form @submit.prevent="updateTopicVideoLink()">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="md-form mt-3">
                                <label class="mb-3">Copy and Paste Video Link</label>
                                <input type="text" class="form-control" v-model="topics.video_link">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="md-form mt-3">
                                <input type="text" v-model="topics.id" class="form-control">
                                <label class="mb-3">Write Content / Copy and Paste</label>
                                <QuillEditor theme="snow" v-model:content="exerciseForm.exercises" content-type="html" />
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                ...
                <form @submit.prevent="updateExercise()">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="md-form mt-3">
                                <input type="text" class="form-control" v-model="all_exercises.id">
                                <label class="mb-3">Write Exercises / Copy and Paste</label>
                                <QuillEditor theme="snow" v-model:content="all_exercises.exercises" content-type="html" />
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
export default {
    ...
    methods: {
        ...
        async storeTopicContent(form) {
            await axios.put(`/topic/content/${this.$route.params.id}`, {
        ...
        async storeExercise() {
            await axios.post('/topic/exercise', {
        ...
        async storeTopicVideoLink() {
            await axios.put(`/topic/video/${this.$route.params.id}`, {
        ...
        async updateTopicVideoLink() {
            await axios.put(`/topic/video/${this.$route.params.id}`, this.topics)
                .then((response) => {
                    this.topics.unshift(response.data);
        ...
        async updateTopicContent() {
            await axios.put(`/topic/content/${this.$route.params.id}`, this.topics)
                .then((response) => {
                    this.topics.unshift(response.data);
        ...
        async updateExercise() {
            await axios.put('/topic/exercise/' + this.all_exercises.id, this.all_exercises)
                .then((response) => {
        ...
        async updateObjective() {
            await axios.put('/topic/objective/' + this.topics.id, this.topics)
                .then((response) => {
                    this.topics.unshift(response.data);
