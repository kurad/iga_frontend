                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>Dive into a dynamic exchange of knowledge from dedicated educators. Pose questions, express
                                your doubts, and receive personalized responses and guidance. Our platform ensures your
                                learning needs are met with care and expertise, making education an engaging and interactive
                                adventure.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>In addition to our online courses, we also offer one-on-one tutoring sessions. Our tutors
                                work with students to identify their strengths and weaknesses, and they develop personalized
                                lesson plans to help them improve.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">iGa was founded with the goal of adding quality to education. We believe that every
                        student deserves access to quality teachers, regardless of where they live. Our team is passionate
                        about education and is dedicated to making a positive impact in the lives of students around
                        Rwanda.​We provide a range of services to students, including access to educational materials,
                        academic support, and guidance from experienced teachers. Our platform is designed to be
                        user-friendly and easy to navigate, making it easy for students to get the help they need to
                        succeed.
                    </p>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid"
                                    src="https://english.varthabharati.in/storage/uploads/india/WPC_vb_02.png" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                                    style="margin: 1px;">
        ...
        <div class="container">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                    <a class="position-relative d-block h-100 overflow-hidden" href="">
                        <img class="img-fluid position-absolute w-100 h-100"
                            src="https://igihe.com/IMG/logo/35-118-2f76c_1_.webp?1672917413" alt=""
                            style="object-fit: cover;">
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:  1px;">
